...
import { tokens } from "../themes/Calendarthemes";
...
const Calendar = () => {
    ...
    const [currentEvents, setCurrentEvents] = useState<{ id: string; title: string; start: string; end: string; allDay: boolean }[]>([]);
    ...
    return (
        <Box m="20px">
            {/* CALENDAR SIDEBAR */}
            <Box flex="1 1 20%" p="15px" borderRadius="4px" style={{ backgroundColor: colors.primary[400] }}>
